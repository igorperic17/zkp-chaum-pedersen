...
mod test {
    ...
    fn test_1024_constants() {
        ...
        let p_hex = hex::decode("").expect("Could not conver to hex");
        let p = BigUint::from_bytes_be(&p_hex);

        let q_hex = hex::decode("F518AA8781A8DF278ABA4E7D64B7CB9D49462353").expect("Could not conver to hex");
        let q = BigUint::from_bytes_be(&q_hex);

        let g_hex = hex::decode("").expect("Could not conver to hex");
        let g = BigUint::from_bytes_be(&g_hex);

        // g^i is also a generator
